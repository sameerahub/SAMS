            ...
            ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo SITEURL; ?>delete-student.php?id=<?php echo $id ?>" class="btn-danger">Delete</a>

                                <!-- <a href="delete-admin.php?id=<?php //echo $id 
                                                                    ?>" class="btn-danger">Delete Admin</a> (or i can write this type)-->

                                <a href="<?php echo SITEURL; ?>update-student.php?id=<?php echo $id ?>" class="btn-secondary">Update</a>
                            </td>
                        </tr>
            <?php
