            ...
            ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo SITEURL; ?>update-password.php?id=<?php echo $id ?>" class="btn-primary">Password</a>

                                <a href="<?php echo SITEURL; ?>delete-admin.php?id=<?php echo $id ?>" class="btn-danger">Delete</a>
